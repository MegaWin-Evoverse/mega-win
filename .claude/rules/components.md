...
Always use `export function`, never `export const` with an arrow. Exception: Next.js file conventions (`page.tsx`, `layout.tsx`, `loading.tsx`, `error.tsx`) use `export default function`:
